...
-- Dumping structure for table dbbelajar-crud-laravel.nilai
CREATE TABLE IF NOT EXISTS `nilai` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `kelas_mahasiswa_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table dbbelajar-crud-laravel.nilai: ~0 rows (approximately)
...
-- Dumping data for table dbbelajar-crud-laravel.users: ~1 rows (approximately)
